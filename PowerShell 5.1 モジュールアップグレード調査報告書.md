...
|-----------|-------------|-------------|------|
| PnP.PowerShell | 1.11.0 | **1.12.0** | PS 5.1 対応の最終版（2.x は PS 7.2+ 必須、3.x は PS 7.4.6+ 必須） |
...
初版では「3.x は PS 7.4+ 必須」と記載していたが、正確には **PS 7.4.6 以上** が必要。最新安定版は **3.1.0**（2025-04-18 公開）。
...
PnP.PowerShell の最新安定版は **3.1.0**（2025-04-18 公開、PS 7.4.6 以上必須）。2.x の最終安定版は **2.12.0**（2024-09-09 公開、PS 7.2+ 必須）。将来の PS 7 移行計画では 3.x を検討対象とすること。
